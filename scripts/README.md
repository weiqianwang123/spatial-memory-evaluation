...
```bash
python scripts/tools/run_claude_task.py 01 --worktree /home/robin_wang/spatial-memory-evaluation-task01 --background
...
`.claude/session_logs/`, which is git ignored.
