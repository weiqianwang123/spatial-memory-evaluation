...
- Formal Track 1/2 uses the shared strongest open-vocabulary detector setup and reports the detector-coverable split. Closed-detector or method-native detector variants are `module_ablation` only.
...
| 0 Policy | `tasks/task_06_shared_module_ov_audit.md` | Claude draft, human final | Freeze formal shared OV detector module policy. |
...
| 1 Fixed API | `tasks/task_10_track12_fixed_api_hovsg_ov.md` | Claude | Implement HOV-SG shared OV-detector Track 1/2 package smoke. |
| 1 Fixed API | `tasks/task_11_track12_fixed_api_dualmap_ov.md` | Claude | Implement DualMap shared OV-detector Track 1/2 route. |
...
- Strongest OV detector/checkpoint and shared module policy for formal Track 1/2 eval.
