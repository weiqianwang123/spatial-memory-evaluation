# Task 12: ConceptGraphs Track 1/2 OV Fixed API

## Goal

Implement or complete ConceptGraphs shared OV-detector Track 1 object export and
determine whether Track 2 fixed API is honestly supported.

## Scope

ConceptGraphs formal Track 1/2 evaluation must use a shared OV variant. Track 2 should
...
- Formal output labels must be canonical shared OV-detector labels.
...
- ConceptGraphs shared OV object export smoke script or package path.
...
- Package declares shared OV detector for formal Track 1/2.
- Track 1 labels are canonical.
- Track 2 is either supported by native query bridge or invalid with reason.

## PR Title

`feat: add conceptgraphs shared ov track1 export`
