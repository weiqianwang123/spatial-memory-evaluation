# Task 06: Shared Module Closed-Vocabulary Audit

## Goal

Freeze the formal closed-vocabulary shared module policy for Track 1/2 and
...
- Formal Track 1/2 uses `vocabulary_mode=closed`.
- Canonical labels must come from one repo-owned class list.
...
- Formal CV detector/class-list policy is explicit.
- OV methods state how they become CV eval variants.
- Missing checkpoints and fallback smoke choices are clearly separated.

## PR Title

`docs: freeze shared closed vocabulary modules`
